...
public class Sem6 {
    public static void main(String[] args) {
        ...
        ms.add(7);
        ms.print();
        System.out.println(ms.toListUpElement(5));
    }
}
class MySet {
    private HashMap<Integer, Object > myset;
    private static final Object OOO = new Object(); // название большими буквами
    public MySet(){
        this.myset = new HashMap<>();
    }
    public void add(Integer number){
        this.myset.putIfAbsent(number, OOO); // записываем, если нет такого ключа
    }
    ...
    public int get(int index){
        return (int)
                this.myset.keySet().toArray()[index];
    }
